...
import { IconUser, IconSparkles, IconClose, IconLock, IconCat } from './Icons';
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 w-full max-w-sm shadow-2xl border border-white/20 dark:border-slate-800 relative">
                ...
                <div className="flex flex-col items-center text-center mb-6">
                    ...
                    <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                        {mode === 'login' ? 'Chào mừng bạn trở lại' : 'Tạo hồ sơ mới'} <IconCat className="w-5 h-5 text-orange-400"/>
                    </h2>
