...
import { IconArrowLeft, IconBook, IconSparkles, IconHeart, IconHeartFilled, IconMessage, IconSend, IconUser, IconClose, IconFeather } from './Icons';
      ...
      <header className="sticky top-0 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl z-40 px-4 py-3 border-b border-white/40 dark:border-slate-800 transition-colors duration-300 shadow-sm">
        <div className="w-full max-w-xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 cursor-pointer group" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
                 <span className="font-serif font-bold text-xl text-transparent bg-clip-text bg-gradient-to-r from-slate-800 to-slate-600 dark:from-slate-100 dark:to-slate-300 group-hover:from-sky-500 group-hover:to-blue-600 transition-all duration-300 flex items-center gap-2">
                     <IconFeather className="w-5 h-5 text-sky-500" /> Góc Suy Ngẫm
                 </span>
            </div>
